...
describe('mew151-mew', () => {
  ...
  it('renders an image', async () => {
    const { root } = await render(<mew151-mew src="test.png" isShiny={() => false}></mew151-mew>);
  ...
  it('can be passed alt text', async () => {
    const { root } = await render(<mew151-mew src="test.png" alt="Unit Test"></mew151-mew>);
  ...
  it('can have a random chance to generate a shiny sprite', async () => {
    const isShiny = () => true;
    const { root } = await render(<mew151-mew src="test.png" alt="Unit Test" isShiny={isShiny}></mew151-mew>);
